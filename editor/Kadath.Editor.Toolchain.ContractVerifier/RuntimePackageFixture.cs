...
internal sealed class RuntimePackageFixture
{
    ...
    internal ToolchainRuntimeArchiveRequest Request(
        ...
        new(
            ...
            beforeFinalOwnedTreeVerificationForTesting,
            betweenFinalOwnedTreeVerificationsForTesting,
            beforeFinalDirectoryMutationCommitForTesting);
    ...
    private static byte[] BuildBehaviorScriptV2()
    {
        ...
        BinaryPrimitives.WriteUInt32LittleEndian(artifact.AsSpan(12, 4), 4);
